...
export function PlayerPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {player.loading && (
        <div className="rounded-md border border-veda-border bg-veda-surface/60 glass px-6 py-10 text-center text-sm text-veda-text-muted">
          Loading...
        </div>
      )}
      ...
      {player.data && !player.loading && (
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <section className="rounded-md border border-veda-border bg-veda-surface/60 glass p-5">
          ...
          <section className="overflow-hidden rounded-md border border-veda-border bg-veda-surface/60 glass">
